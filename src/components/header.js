...
export default function Header() {
    ...
    const [modalShow, modalManage] = useState(false)
    return (
        <>
                ...
                cart.length > 0 ?
                    <div>
                        <li className="font-sans block mt-4 lg:inline-block lg:mt-0 lg:ml-6 align-middle text-black hover:text-gray-700">
                            <button onClick={()=>modalManage(true)} datadrawertarget="cart-drawer" datadrawershow="cart-drawer" aria-controls="cart-drawer" role="button" className="relative flex">
        ...
        <Cart modalManage={modalManage} modalShow={modalShow}/>
        </>
    )
}